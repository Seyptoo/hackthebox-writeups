...
Voilà nous avons enfin accès au fichier nous allons essayer de lire le fichier ruby.
...
Une fois le fichier transférer suffis de le chmod et d'éxecuter le programme viewuser.
